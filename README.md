...
| :--------- | :---------- | :--- |
| [Curated lists & registries](./docs/curated-lists.md) | Curated compilations, awesome lists, and community software/data registries for computational materials science. | List, App, Code/Sim, Code/WF, Data |
...
| Item (URL) | Description | Tags |
| :--------- | :---------- | :--- |
| [Educational resources](./docs/ocw-cms.md) | Academic courses, interactive simulation applets, computational notebooks, and research software workshops for materials science. | List, Edu, App, Code/ML, Code/Sim, Code/Lib |
